...
class PageDagger extends StatefulWidget {
  ...
  @override
  _PageDaggerState createState() => _PageDaggerState();
}

class _PageDaggerState extends State<PageDagger> {
  ...
  onDragEnd(DragEndDetails details) {
    widget.slideUpdateStream
        .add(new SlideUpdate(UpdateType.doneDragging, SlideDirection.none, 0.0));
